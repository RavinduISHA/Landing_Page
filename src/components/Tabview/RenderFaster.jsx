        ...
        <div className="flex md:flex-row flex-col">
          <div className="flex flex-col md:gap-12 md:ml-36 md:w-[50%] md:mt-12">
            ...
            <div className="text-center md:text-start">
              <h1 className="text-[100px] text-black font-[500] md:text-[170px] md:leading-[70px] leading-[50px]">
                8x
              </h1>
              <p className="text-secondry md:text-[20px] text-[22px] md:font-medium font-[450] md:leading-[25px] md:mt-16 py-8 w-full md:w-[60%] lg:w-[90%] md:py-0">
          ...
          <div className="flex md:w-[50%] mt-12 md:mt-0 items-center justify-center md:justify-start">
            <div className="relative md:w-[350px] md:h-[350px] w-[250px] h-[250px] rounded-full bg-[#B6DFEC] flex items-center justify-center">
              ...
              <div className="flex flex-col items-center justify-center w-40 h-40 md:w-60 md:h-60 rounded-full bg-white text-center">
                <h1 className="md:text-[45px] font-[600] text-[35px]">
                  Render
                </h1>
